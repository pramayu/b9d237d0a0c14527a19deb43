        ...
        <View style={{width: '100%', height: '100%', flexDirection: 'row'}}>
            <View style={{width: '60%'}}>
                <View style={{width: '100%', flexDirection: 'row', paddingTop: 10}}>
                    <View style={{width: '12%'}}>
                        <SimpleLineIcons name="earphones" size={17} color="#3d72de" />
                    </View>
                    <View style={{width: '88%'}}>
                        <Text style={{color: '#323a5a', fontSize: 12, paddingTop: 2, paddingLeft: 5, fontFamily: 'Brandon_Medium'}}>AUDIOBOOK</Text>
                    </View>
                </View>
            </View>
