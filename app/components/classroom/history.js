            ...
            <View style={{width: '100%', flexDirection: 'row', marginTop: 10}}>
                <View style={{width: width / 3, height: '100%', marginRight: 20}}>
                    <LinearGradient colors={['#6754b9','#3d2c88']} style={{width: '100%', height: width / 1.9, borderRadius: 6, elevation: props.elevation === false ? 0 : 20, padding: 15}}>
                        ...
                        <View style={{width: '100%', height: 6, borderRadius: 4, backgroundColor: '#3d2c88', marginTop: 15, justifyContent: 'center', paddingHorizontal: 2}}>
                            <View style={{width: '50%', height: 4, borderRadius: 2, backgroundColor: '#6754b9'}}></View>
                        </View>
                ...
                <View style={{width: width / 3, height: '100%', marginRight: 20}}>
                    <LinearGradient colors={['#9fb2ac','#505e5e']} style={{width: '100%', height: width / 1.9, borderRadius: 6, elevation: props.elevation === false ? 0 : 20, padding: 15}}>
                        ...
                        <View style={{width: '100%', height: 6, borderRadius: 4, backgroundColor: '#505e5e', marginTop: 15, justifyContent: 'center', paddingHorizontal: 2}}>
                            <View style={{width: '45%', height: 4, borderRadius: 2, backgroundColor: '#9fb2ac'}}></View>
                        </View>
                ...
                <View style={{width: width / 3, height: '100%', marginRight: 20}}>
                    <LinearGradient colors={['#f0a168','#c26c55']} style={{width: '100%', height: width / 1.9, borderRadius: 6, elevation: props.elevation === false ? 0 : 20, padding: 15}}>
                        ...
                        <View style={{width: '100%', height: 6, borderRadius: 4, backgroundColor: '#c26c55', marginTop: 15, justifyContent: 'center', paddingHorizontal: 2}}>
                            <View style={{width: '70%', height: 4, borderRadius: 2, backgroundColor: '#f0a168'}}></View>
                        </View>
